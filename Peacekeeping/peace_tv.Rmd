...
We'll now collapse the data to one row per conflict ID, using the first row. We'll add a new variable `peacekeepers` to indicate whether there were peacekeepers at any time.
...
peace %>% 
  ...
  select(id, cname, cfdate, faildate, outcome, pk_dum, pkop, peacekeepers)
```
