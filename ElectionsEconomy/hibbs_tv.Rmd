...
<!-- abline(coef(model), col="gray15") -->
<!-- with(hibbs, points(growth, vote, pch=20)) -->
<!-- text(2.7, 53.5, paste("y =", fround(coef(model)[1],1), "+", fround(coef(model)[2],1), "x"), adj=0, col="gray15", cex=1.3) -->
<!-- ``` -->
<!-- ```{r eval=FALSE, include=FALSE} -->
<!-- if (savefigs) dev.off() -->
<!-- ``` -->
...
<!-- y_point_pred <- predict(model, newdata=new) -->
<!-- ``` -->
...
<!-- ```{r } -->
<!-- y_linpred <- posterior_linpred(model, newdata=new) -->
<!-- ``` -->
...
<!-- ```{r } -->
<!-- y_pred <- posterior_predict(model, newdata=new) -->
<!-- ``` -->
...
<!-- y_point_pred_grid <- predict(model, newdata=new_grid) -->
<!-- y_linpred_grid <- posterior_linpred(model, newdata=new_grid) -->
<!-- y_pred_grid <- posterior_predict(model, newdata=new_grid) -->
<!-- ``` -->
...
<!-- ```{r } -->
<!-- modela <- lm(vote ~ growth, data=hibbs) -->
<!-- print(modela) -->
<!-- summary(modela) -->
<!-- ``` -->
