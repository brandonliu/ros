...
The `glm()` coefficients for 1960 - 1972. The `black` variable is nonidentifiable in 1964.
...
The estimates above look fine except in 1964, where there is complete separation for the `black` variable.
